...
CREATE TABLE IF NOT EXISTS pokja_1 (
    ...
    simulasi_lansia_jml_kelompok INT DEFAULT 0,
    simulasi_lansia_jml_anggota INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS pokja_2 (
    ...
    paket_a_warga_belajar_a INT DEFAULT 0,
    paket_a_warga_belajar_b INT DEFAULT 0,
    paket_b_kelompok INT DEFAULT 0,
    paket_b_warga_belajar_a INT DEFAULT 0,
    paket_b_warga_belajar_b INT DEFAULT 0,
    paket_c_kelompok INT DEFAULT 0,
    paket_c_warga_belajar_a INT DEFAULT 0,
    paket_c_warga_belajar_b INT DEFAULT 0,
    taman_bacaan INT DEFAULT 0,
    kelompok_pembaca INT DEFAULT 0,
